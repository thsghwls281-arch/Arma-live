...
export default function Live(){
 ...
 return <main className="mx-auto min-h-screen max-w-5xl px-4 py-8">
  <header><div className="text-xs font-black tracking-widest text-blue-600">INDEPENDENT · NO DATABASE</div><h1 className="mt-2 text-4xl font-black">ARMA LIVE</h1><p className="mt-2 text-sm text-slate-500">KB 현재가 기준 전체 LIVE TOP20과 섹터별 TOP5를 계산합니다.</p></header>
  ...
  {mode==="single"?<>
   ...
   <section className="mt-4 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
    ...
    <p className="mt-4 text-xs font-bold text-slate-400">수동 실행 · A/M 공통 재사용 · 종목·결과 5분 캐시 · 자동 호출 없음</p>
   </section>
